...
// UpdateProfile updates the authenticated user's details and preferences
...
// GetUserProfile fetches public profile info for a specific user ID
func (h *UserHandler) GetUserProfile(c *gin.Context) {
	...
	err = h.DB.Select("id, username, profile_picture, bio, country, city, allow_followers, created_at").
