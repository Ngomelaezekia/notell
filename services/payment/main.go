...
type Payment struct { ID string `gorm:"primaryKey"`; UserID string `gorm:"index;not null"`; Amount int64; Currency string; Status string `gorm:"index;not null"`; Provider string; ProviderID string `gorm:"index"`; IdempotencyKey string `gorm:"uniqueIndex;not null"`; CreatedAt time.Time; UpdatedAt time.Time }
